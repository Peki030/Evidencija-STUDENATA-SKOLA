...
def login():
    if request.method == "GET":#ovo sluzi za prikaz 
        return render_template("login.html")#prikazuje template login.html

    if request.method == "POST":
        forma = request.form#povezivanje sa formom
        ...
        if korisnik != None:
            if korisnik["lozinka"] == forma["lozinka"]:#uporedjivanje lozinke iz baze i forme
